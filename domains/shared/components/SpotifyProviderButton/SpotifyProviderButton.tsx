...
import styles from './SpotifyProviderButton.module.css'

interface SpotifyProviderButtonProps {
    text?: string
    type?: 'button' | 'submit' | 'reset'
    size?: 'small' | 'medium' | 'large'
}

const SpotifyProviderButton: FC<SpotifyProviderButtonProps> = ({ text = 'spotify provider button', type = 'button', size = 'medium' }) => {
    return (
